...
import com.example.pioneer.vocabulary_app_project.util.MD5;
...
public class MainTrActivity extends Activity {
    ...
    private String appid = "20180307000132626";//APP ID
    private String salt = "512";//随机数
    private String secretkey = "95iYKPzWDSB2pFplmY16";//密钥
