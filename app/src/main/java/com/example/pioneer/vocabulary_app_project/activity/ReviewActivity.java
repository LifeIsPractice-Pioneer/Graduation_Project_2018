...
public class ReviewActivity extends Activity implements OnClickListener {
        ...
        if (currentnum < list.size()) {
            ...
            Dialog dialog = new AlertDialog.Builder(this)
                    ...
                    /* User clicked OK so do some stuff */
                            ...
                            intent.setClass(ReviewActivity.this, ReviewMainActivity.class);
    ...
    public void onClick(View v) {
        ...
        if (v == add) {
            DataAccess data = new DataAccess(ReviewActivity.this);
            ...
            if (attention.size() == 0) {
                ...
                Toast.makeText(ReviewActivity.this, "已加入生词本", Toast.LENGTH_SHORT).show();
            } else Toast.makeText(ReviewActivity.this, "生词本中已包含这个单词！", Toast.LENGTH_SHORT).show();
        }
    }
