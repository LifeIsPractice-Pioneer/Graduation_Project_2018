package com.example.pioneer.vocabulary_app_project.database;
...
import com.example.pioneer.vocabulary_app_project.activity.ImportBookActivity;
...
public class DataAccess {
    ...
    public boolean initBook(String bookname, ArrayList<Word> list, String numOfList, String NewName) throws Exception {
        ...
        ImportBookActivity.result = bookID;
        cursor.close();
