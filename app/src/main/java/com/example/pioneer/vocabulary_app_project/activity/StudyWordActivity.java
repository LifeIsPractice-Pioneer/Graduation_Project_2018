...
public class StudyWordActivity extends Activity implements OnClickListener {
    private TextView tv;
    ...
    public void onClick(View v) {
        ...
        if (v == nextone) {
            ...
            DataAccess data = new DataAccess(StudyWordActivity.this);
            ...
            if (attention.size() == 0) {
                ...
                Toast.makeText(StudyWordActivity.this, "已加入生词本", Toast.LENGTH_SHORT).show();
            } else
                Toast.makeText(StudyWordActivity.this, "生词本中已包含这个单词！", Toast.LENGTH_SHORT).show();
