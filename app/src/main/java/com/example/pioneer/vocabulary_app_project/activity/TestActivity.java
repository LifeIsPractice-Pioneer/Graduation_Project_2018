    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.attention.setOnClickListener(new Button.OnClickListener() {
            ...
            public void onClick(View v) {
                DataAccess data = new DataAccess(TestActivity.this);
                ...
                if (attention.size() == 0) {
                    ...
                    Toast.makeText(TestActivity.this, "已加入生词本", Toast.LENGTH_SHORT).show();
                } else Toast.makeText(TestActivity.this, "生词本中已包含这个单词！", Toast.LENGTH_SHORT).show();
            }
        ...
        overBtn.setOnClickListener(new Button.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Dialog dlg = new AlertDialog.Builder(TestActivity.this)
                        .setTitle("测试结果")
...
//			    		intent.setClass(TestActivity.this, MainVoActivity.class);
