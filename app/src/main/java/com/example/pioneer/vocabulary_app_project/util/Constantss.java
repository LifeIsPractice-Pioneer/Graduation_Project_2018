...
public class Constantss {
    ...
    /**
     * 新浪微博开放平台：APP_KEY = "2594809812"
     */
    public static final String APP_KEY = "2594809812";

    /**
     * 当前 DEMO 应用的回调页
     * <p>
     * 授权回调页对移动客户端应用来说对用户是不可见的，所以定义为何种形式都将不影响，
     * 但是没有定义将无法使用 SDK 认证登录
     * <p>
     * 默认回调页：https://api.weibo.com/oauth2/default.html
     */
