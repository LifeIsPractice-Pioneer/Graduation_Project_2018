...
import com.example.pioneer.vocabulary_app_project.Business.OperationOfBooks;
import com.example.pioneer.vocabulary_app_project.R;
import com.example.pioneer.vocabulary_app_project.database.DataAccess;
import com.example.pioneer.vocabulary_app_project.model.BookList;
import com.example.pioneer.vocabulary_app_project.model.WordList;


public class ReviewMainActivity extends TabActivity implements TabHost.TabContentFactory {
    private int week = 0;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        th.addTab(th.newTabSpec("shouldreview").setIndicator("该复习的LIST", ReviewMainActivity.this.getResources().getDrawable(R.drawable.should)).setContent(this));
        th.addTab(th.newTabSpec("alllists").setIndicator("所有LIST", ReviewMainActivity.this.getResources().getDrawable(R.drawable.all)).setContent(this));
        th.addTab(th.newTabSpec("plan").setIndicator("我的复习计划", ReviewMainActivity.this.getResources().getDrawable(R.drawable.plan)).setContent(this));
    }
    ...
    public View createTabContent(final String tag) {
        ...
        if (tag.equals("shouldreview")) {
            ...
            lv.setOnItemLongClickListener(new OnItemLongClickListener() {
                ...
                public boolean onItemLongClick(AdapterView<?> arg0, View arg1,
                                               final int arg2, long arg3) {
                    // TODO Auto-generated method stub
                    Dialog dialog = new AlertDialog.Builder(ReviewMainActivity.this)
                            ...
                            .setItems(new String[]{"标记为已复习"}, new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialog, int which) {
                                    // TODO Auto-generated method stub
                                    if (which == 0) {
                                        DataAccess data = new DataAccess(ReviewMainActivity.this);
                                        ...
                                        intent.setClass(ReviewMainActivity.this, ReviewMainActivity.class);
                                        finish();
                    ...
                    if (wordlist.get(arg2).getLearned().equals("0")) {
                        Dialog dialog = new AlertDialog.Builder(ReviewMainActivity.this)
                                ...
                                /* User clicked OK so do some stuff */
                                        ...
                                        intent.setClass(ReviewMainActivity.this, StudyWordActivity.class);
        ...
        if (tag.equals("plan")) {
            ...
            lv.setAdapter(new SimpleAdapter(ReviewMainActivity.this, getData(tag), R.layout.list3, new String[]{"date", "lists", "day", "image"}, new int[]{R.id.date, R.id.lists, R.id.day, R.id.list3_image}));
            ...
            addbutton.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    week++;
                    lv.setAdapter(new SimpleAdapter(ReviewMainActivity.this, getData(tag), R.layout.list3, new String[]{"date", "lists", "day", "image"}, new int[]{R.id.date, R.id.lists, R.id.day, R.id.list5_image}));
                }
            ...
            LinearLayout newll = new LinearLayout(ReviewMainActivity.this);
    ...
    private void startReview(final int arg2, final int tag) {
        ...
        Dialog dialog = new AlertDialog.Builder(ReviewMainActivity.this)
                ...
                /* User clicked OK so do some stuff */
                        ...
                        intent.setClass(ReviewMainActivity.this, ReviewActivity.class);
                        intent.putExtras(bundle);
                        finish();
                        startActivity(intent);
                    }
