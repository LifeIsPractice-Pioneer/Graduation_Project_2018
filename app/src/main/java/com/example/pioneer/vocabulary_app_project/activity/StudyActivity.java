...
public class StudyActivity extends TabActivity implements TabHost.TabContentFactory {
    /**
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        th.addTab(th.newTabSpec("studid").setIndicator("未学过的LIST", StudyActivity.this.getResources().getDrawable(R.drawable.not_learn)).setContent(this));
        th.addTab(th.newTabSpec("all").setIndicator("所有的LIST", StudyActivity.this.getResources().getDrawable(R.drawable.all)).setContent(this));
    }
        ...
        if (tag.equals("all")) {
            ...
            lv.setOnItemLongClickListener(new OnItemLongClickListener() {
                ...
                public boolean onItemLongClick(AdapterView<?> arg0, View arg1,
                    ...
                    // TODO Auto-generated method stub
                    Dialog dialog = new AlertDialog.Builder(StudyActivity.this)
                            ...
                            .setItems(new String[]{"标记为已学习"}, new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialog, int which) {
                                    // TODO Auto-generated method stub
                                    if (which == 0) {
                                        DataAccess data = new DataAccess(StudyActivity.this);
                                        ...
                                        intent.setClass(StudyActivity.this, StudyActivity.class);
                                        finish();
                ...
                Dialog dialog = new AlertDialog.Builder(StudyActivity.this)
                        ...
                        .setPositiveButton("确定", new DialogInterface.OnClickListener() {
                         ...
                         /* User clicked OK so do some stuff */
                                ...
                                intent.setClass(StudyActivity.this, StudyWordActivity.class);
...
//    	 switch(position){
//    	 case 0:
//    		 intent = new Intent(StudyActivity.this,StudyWordActivity.class);
//    		 startActivity(intent);
//    		 break;
//    	 case 1:
//    		 intent = new Intent(StudyActivity.this,StudyWordActivity.class);
